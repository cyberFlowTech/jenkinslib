...
def NotifyV2(envi,result) {    
    ...
    sh """
curl -X POST -H "Content-Type:application/json" -H "type:info" --data-binary \$\\'{\\"api\\":\\"m_1691395720\\",\\"data\\":\\"abc%0D%0Adef%0D%0Aghi%0D%0A\\"}\\' https://web3.mimo.immo/notify/notify
    """
